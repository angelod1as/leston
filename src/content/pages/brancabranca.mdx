...
At the end of last year, I started the series 256x256x256x256 as a way to study the perception of movement and color. To do that, I created a series of rules: 256x256 grid, 256 shades of color, and 256 frames. Also, every pixel changes color linearly from 1 to 256, and there are 256 pixels in each of the 256 colors in every frame.
