...
Unlike the previous batches, all 16 pieces will be minted next Monday, 16 editions each, as a Branca Branca collection on Objkt.com. One of them will be a special Collectors Edition, which will be airdropped to the top 16 collectors of the series.

**If you would like to reserve, please place a bid (8 tez or above) on any of the pieces you would like to get. I will accept your offers before swapping the remainders, which will be done next Friday. I will let you know as soon as they are all minted.**
...
<Link href="http://example.com">Esse é um teste</Link>
  ...
  <Col1>
    ...
    <Col1>
    <Image alt="image" path="/pages/a.gif" width={1024} height={1024}>
      Aqui vai a legenda e será que dá pra colocar parágrafo?<br />
      <Link href="http://example.com">Esse é um teste</Link>
    </Image>
  </Col1>
  <Col1>
